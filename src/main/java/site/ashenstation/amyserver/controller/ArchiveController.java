...
public class ArchiveController {
    ...
    public void amyPath(@PathVariable String platform, @PathVariable String _arch, @PathVariable String archive, HttpServletResponse response) throws IOException {
        String amy = publishArchiveService.getLatestArchivePath(platform, _arch, "amy", archive);
